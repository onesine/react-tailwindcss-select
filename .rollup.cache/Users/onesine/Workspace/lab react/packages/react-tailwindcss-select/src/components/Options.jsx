...
const Options = ({ list, noOptionsMessage, text, isMultiple, value, primaryColor = DEFAULT_THEME }) => {
    ...
    return (<div role="options" className={classNames && classNames.list ? classNames.list : "max-h-72 overflow-y-auto"}>
            {filterResult.map((item, index) => (<React.Fragment key={index}>
                    {"options" in item ? (<>
