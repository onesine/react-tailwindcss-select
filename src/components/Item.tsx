        ...
        <>
            {item.disabled ? (
                ...
                <li
                    ...
                    className={`block transition duration-200 px-2 py-2 cursor-pointer select-none truncate rounded ${isSelected ? `text-white ${bgColor}` : `${textColor} ${bgHoverColor} ${textHoverColor}` }`}
                >
                    {item.label}
                </li>
            )}
